...
class TintImage(object):
    def __init__(self, tint_color_range=((0, 255), (0, 255), (0, 255))):
        self.tint_color_range = tint_color_range
    
    def __call__(self, image):
        tint_color = tuple(np.random.randint(low, high) for low, high in self.tint_color_range)
