...
from typing import Callable, List, Optional, Sequence, Tuple, Union, Any, Dict
...
class CONCHConfig: 
    ...
    architectures: Optional[Any] = None
    ...
    id2label: Dict[str, str] = field(default_factory=lambda: {"0": "LABEL_0", "1": "LABEL_1"})
    init_values: float = 1e-06
    ...
    pruned_heads: Dict[Any, Any] = field(default_factory=dict)
    qkv_bias: bool = True
    ...
    transformers_version: str = "4.46.0"
    typical_p: float = 1.0
