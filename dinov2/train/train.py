...
from dinov2.data import collate_data_and_cast, DataAugmentationDINO, DataAugmentationCytologia, MaskingGenerator
...
def do_train(cfg, model, resume=False):
    ...
    dataset = make_dataset(
        dataset_str=cfg.train.dataset_path_unsup,
    ...
    for data in metric_logger.log_every(
        ...
        loss_dict = model.forward_backward(data, data_sup, teacher_temp=teacher_temp)
