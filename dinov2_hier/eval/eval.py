...
def main(args):
    train_dataset = CustomImageDataset(df, transform=transform, dic_mapping = dic_mapping)
    test_dataset = CustomImageDataset(df_test, transform=transform, dic_mapping = dic_mapping)
